...
<?php include "includes/nav.php";?>
			...
			<div class="row">
				<div class="col-md-4 animate-box">
					<div class="services">
						<i class="icon-dog"></i>
						<div class="desc">
							<h3>1. collects DNA sample</h3>
							<img src="images/how_it_works_1.png" alt="" class="img-responsive">
							<p>Gentle cheek swap collects DNA sample</p>
						</div>
					</div>
				</div>
				<div class="col-md-4 animate-box">
				...
				<div class="col-md-4 animate-box">
					<div class="services">
						<i class=""></i>
						<div class="desc">
							<h3>3. PooPrints Waste sample collection</h3>
		...
		<div class="container">
			<div class="col-md-12 text-center animate-box">
				...
				<p><a href="contact.php" class="btn btn-primary btn-outline with-arrow">Get started now! <i class="icon-arrow-right"></i></a></p>
			</div>
		</div>
	</div>
